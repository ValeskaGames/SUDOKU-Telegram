...
namespace BotCode
{
    ...
    class Program
    {
        static int[,,] BaseDataStorage; // array for storage of heatmap data
                    ...
                    case State.Menu:
                        {
                            ...
                            {
                                BaseDataStorage = Command.GetInf();
                    ...
                    case State.Statistics:
                        {
                            ...
                            {
                                await botclient.SendTextMessageAsync(message.Chat, Command.Render(BaseDataStorage,Convert.ToInt16(Convert.ToInt32(message.Text)-1)));
                            }
                            Command.Admin(message, botclient, data);
                            break;
                        }
